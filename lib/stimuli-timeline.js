...
const intertemporalQuestionContent = `
Please state which option you prefer on each row by clicking an option on the row where you would like to
switch from choosing Option B to choosing Option A. 
If you click Option B on a row, we assume you will choose Option B for any row above that row. 
If you click Option A on a row, we assume you will choose Option A for any row below that row. 
After one click, some rows may unfold and you need to make another choice. 
`
